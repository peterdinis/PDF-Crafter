		...
		<div className="min-h-screen bg-linear-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 flex flex-col items-center justify-center p-4">
			<div className="relative">
				...
				<div className="relative w-64 h-80 bg-white dark:bg-slate-800 rounded-lg shadow-2xl border border-slate-200 dark:border-slate-700 overflow-hidden">
						...
						<div className="mt-8 space-y-2">
							...
							{[...Array(3)].map((_, i) => (
								<div key={i} className="flex space-x-2">
									<div
										className="h-3 flex-1 bg-linear-to-r from-slate-100 to-slate-50 dark:from-slate-800 dark:to-slate-700 rounded animate-pulse"
										style={{ animationDelay: `${i * 0.1}s` }}
									></div>
									<div
										className="h-3 w-16 bg-linear-to-r from-slate-100 to-slate-50 dark:from-slate-800 dark:to-slate-700 rounded animate-pulse"
										style={{ animationDelay: `${i * 0.1}s` }}
									></div>
								</div>
							))}
					...
					<div className="absolute bottom-4 left-0 right-0 flex justify-center">
						<div className="flex items-center space-x-2 px-4 py-2 bg-white dark:bg-slate-800 rounded-full shadow-lg">
							...
							<div className="w-8 h-8 flex items-center justify-center">
								<div
									className="w-4 h-4 border-t-2 border-r-2 border-blue-500 rotate-45 animate-pulse"
				...
				<div className="absolute -top-8 -left-8 w-16 h-16">
					<div
						className="absolute inset-0 bg-linear-to-r from-blue-500 to-cyan-500 rounded-full animate-bounce"
				...
				<div className="absolute -bottom-6 -right-6 w-14 h-14">
					<div
						className="absolute inset-0 bg-linear-to-r from-green-500 to-emerald-500 rounded-full animate-bounce"
				...
				<div className="absolute -bottom-4 -left-4">
					<div
						className="w-10 h-10 border-4 border-emerald-200 dark:border-emerald-800 border-t-emerald-500 dark:border-t-emerald-400 rounded-full animate-spin"
			...
			<div className="mt-12 text-center space-y-6">
				<div className="space-y-2">
					...
					<p className="text-slate-600 dark:text-slate-300 max-w-md">
						Preparing all elements, formatting content and optimizing for
						printing...
					</p>
				</div>
