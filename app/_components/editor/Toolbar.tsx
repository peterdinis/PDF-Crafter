...
export const Toolbar: React.FC<ToolbarProps> = ({
  ...
  const tools = [
    ...
    { name: 'Striped Table', value: 'table_striped' as Tool, icon: TableProperties },
    { name: 'Bordered Table', value: 'table_bordered' as Tool, icon: GripHorizontal },
  ];

  return (
    <div className="w-64 bg-editor-background border-r border-editor-border flex flex-col">
      <div className="p-4 border-b border-editor-border">
        <h2 className="text-lg font-semibold text-editor-foreground">PDF Crafter Ninja</h2>
      </div>
      
      <div className="p-4">
        <h3 className="text-sm font-medium text-editor-foreground mb-3">Tools</h3>
          ...
          {tools.map((tool) => (
            <div
              ...
              className={cn(
                ...
                activeTool === tool.value && "bg-editor-primary/20 text-editor-primary"
              )}
