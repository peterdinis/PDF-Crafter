...
const PDFEditor = () => {
	...
	const getDefaultTextContent = (style: string): string => {
		switch (style) {
			...
			case "quote":
				return "This is an important quote that needs to stand out from the rest of the text.";
			case "list":
				return "• Item 1\n• Item 2\n• Item 3\n• Item 4";
			case "numbered":
				return "1. First item\n2. Second item\n3. Third item\n4. Fourth item";
			...
			switch (activeTool) {
				...
				case "text_numbered":
					...
					newElement = {
						...
						width: 300,
						height:
							textStyle.includes("list") || textStyle.includes("numbered")
								? 120
								: 80,
				...
				case "table_invoice":
					...
					newElement = {
						...
						y,
						width:
							tableStyle === "wide" || tableStyle === "calendar" ? 400 : 300,
				...
				case "form_range":
					...
					newElement = {
						...
						width: 200,
						height:
							formType === "textarea" ? 80 : formType === "button" ? 36 : 40,
