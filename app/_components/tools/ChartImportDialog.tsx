...
export const ChartImportDialog: FC<ChartImportDialogProps> = ({
    ...
    const [parsedData, setParsedData] = useState<{ label: string; value: number }[]>([]);
        ...
        <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
            <DialogContent className="max-w-2xl max-h-[90vh] flex flex-col">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Paste CSV, JSON or upload a file to import data points. Supported formats: Label,Value OR JSON arrays.
                    </DialogDescription>
                </DialogHeader>
